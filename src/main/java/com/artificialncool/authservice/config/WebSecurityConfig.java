package com.artificialncool.authservice.config;

import com.artificialncool.authservice.security.RestAuthenticationEntryPoint;
import com.artificialncool.authservice.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/user/all");
